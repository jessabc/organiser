...
import TodosLink from './todosLink/TodosLink'
...
{/* removed z-[60] so modal will work */}
    {/* brand */}
    <div className="px-6">
      <a className="flex-none text-2xl  dark:text-white dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600  font-extrabold text-transparent bg-clip-text bg-gradient-to-br from-indigo-300 to-indigo-800" href="#" aria-label="Brand">Organiser.</a>
    </div>
