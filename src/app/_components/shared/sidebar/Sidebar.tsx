...
export default function Sidebar() {
  return (
      ...
      {/* removed z-[60] so modal will work */}
        ...
        <div className="px-6">
          <Link className="flex-none text-2xl  dark:text-white dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600  font-extrabold text-transparent bg-clip-text bg-gradient-to-br from-indigo-300 to-indigo-800" href={"/"} aria-label="Brand">Organiser.</Link>
        </div>
