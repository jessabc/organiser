...
const schema = yup.object({
  ...
  //  newCategory: yup.string().required('New Category is a required field'),
...
export default function TransactionForm({closeModal, transactionFormType, thisTransaction=null}) {
  ...
  const onSubmit: SubmitHandler<Inputs> = (data) => {
    ...
    const newTransaction =   {
      id: thisTransaction? thisTransaction.transaction.id : Math.random(),
      type: data.type,
    ...
    if(transactionFormType === 'new') {
      ...
      // else replace
      const updatedTransactions = card.transactions.map(transaction => transaction.id === thisTransaction.transaction.id ? newTransaction: transaction)
      dispatch(setAllTransactions(updatedTransactions))
    }
  
    // update card amount either plus or minus new transaction amount
    if(data.type === 'income') {
        ...
        <div className='m-10 flex flex-col'>
          ...
          <div className="flex flex-col gap-1 mb-5">
            ...
            <div className={``}>
              ...
              <input 
                ...
                value="income" 
                id="income" 
                defaultChecked = {thisTransaction ?  thisTransaction.transaction.type === 'income' ? true : false : false}
            ...
            <div className={``}>
              ...
              <input 
                ...
                value="expense" 
                id="expense" 
                defaultChecked = {thisTransaction ?  thisTransaction.transaction.type === 'expense' ? true : false : true} 
                className="shrink-0 mt-0.5 border-gray-200 rounded-full text-blue-600 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-gray-800 dark:border-gray-700 dark:checked:bg-blue-500 dark:checked:border-blue-500 dark:focus:ring-offset-gray-800"
              />
              <label 
                htmlFor="expense" 
          ...
          <div className="flex flex-col gap-2 mb-5">
            ...
            type='number'
              id='amount' 
              {...register('amount')} 
              defaultValue={transactionFormType === 'edit' ? thisTransaction.transaction.amount : null} placeholder="20" 
          ...
          <div className="flex flex-col gap-2 mb-5">
            ...
            type='date'
              id='date' 
              {...register('date')} 
              defaultValue={transactionFormType === 'edit' ? thisTransaction.transaction.date : null} 
          ...
          <div className={``}>
            ...
            <input 
              id='notes' 
              defaultValue={transactionFormType === 'edit' ? thisTransaction.transaction.notes : null} 
          ...
          <section className='my-2 flex flex-col '>
            ...
            <select 
              ...
              onChange={(e) => checkOnChange(e.target.value)} defaultValue={transactionFormType === 'edit' && thisTransaction.transaction.category}
              >
