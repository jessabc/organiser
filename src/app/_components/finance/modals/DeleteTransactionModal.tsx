...
export default function DeleteTransactionModal({ thisTransaction }: Props) {
  ...
  function handleOnDelete() {
    const updatedTransactions = card.transactions.filter(
      (transaction) => transaction.id != thisTransaction.id
    );
  ...
  function ButtonProps() {
    return (
      <button
        type="button"
        onClick={openModal}
        className="hover:text-gray-500 dark:hover:text-gray-600"
      >
        <svg
    ...
    <>
      ...
      >
        <div className="flex flex-col">
          ...
          <div className="m-5">
            <p className="font-semibold text-lg text-red-500 mb-3">
              Delete transaction
            </p>
            <p className="mb-5">
